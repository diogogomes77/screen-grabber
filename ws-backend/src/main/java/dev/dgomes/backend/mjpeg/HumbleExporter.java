...
public class HumbleExporter {
    ...
    public HumbleExporter(String filename, StorageService storageService, int snapsPerSecond) {
        muxer = storageService.getMuxer(filename);
        fps = snapsPerSecond;
    }

    public void open(int w, int h) throws Exception {
        System.out.println("HumbleExporter open ");
        ...
        System.out.println("HumbleExporter open concluded");

    }


    public void encode(BufferedImage im) throws Exception {
        //System.out.println("HumbleExporter encode ");
        ...
        do {
            ...
            if (packet.isComplete()){
                ...
                System.out.println("HumbleExporter muxer write");
            }
